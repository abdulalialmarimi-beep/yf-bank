...
async def marry_cmd(ctx, user: discord.User, dowry: int = 0):
    ...
    async def pay_cb(i: discord.Interaction):
        ...
        async def yes_cb(i2: discord.Interaction):
            ...
            e3.set_image(url="https://i.pinimg.com/originals/3b/4a/5e/3b4a5e2b2b2b2b2b2b2b2b2b2b2b2b2b.jpg")
            add_ach(e3, new_ach)
...
async def divorce_cmd(ctx, user: discord.User = None):
    ...
    e.set_image(url="https://i.cartoonstock.com/cartoonstock_web/2013/07/bald0166_low.jpg")
    await ctx.send(embed=e)
